...
@Component({
  selector: 'app-paymentenfant',
  templateUrl: './paymentenfant.component.html',
  styleUrls: ['./paymentenfant.component.css']
})
export class PaymentenfantComponent implements OnInit {
...
showpa:boolean=false
  ...
  tab: any = []
  tabb: any = []
  liste_libellle=["aaa","bbb","ccc"]
  liste_valeur=[500,255,200]
  liste_pois=[10,25,15]
  listobjet=[]
t:any=[]
c=false
  ...
  //  this.azer()
    ...
    let o:any={
      a:'',b:0,c:0
          ...
          for (let i = 0; i < this.liste_pois.length; i++) {
                const element = this.liste_libellle[i];
                o.a=this.liste_libellle[i]
                o.b=this.liste_valeur[i]
    
                  o.c=this.liste_pois[i]
                  this.listobjet.push(o)
...
window.open("printreglementens/"+d.idreg)
     ...
     imppact(d){
      window.open("printreglement/"+d.idreg)
