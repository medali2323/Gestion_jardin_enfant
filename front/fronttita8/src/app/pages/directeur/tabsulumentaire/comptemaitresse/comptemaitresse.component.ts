...
import { maitres } from './maitres';

@Component({
  selector: 'app-comptemaitresse',
  templateUrl: './comptemaitresse.component.html',
  styleUrls: ['./comptemaitresse.component.css']
})
export class ComptemaitresseComponent implements OnInit {
  ...
  public dataSource = new MatTableDataSource<maitres>();
  las:any=[]
  parents:any=[]
listactivite(){
                ...
                u2.forEach(elt2 => {
                  ...
                  if(elt2.username==element.username){
                   ...
                   element.username2=elt2.username[0]  + "******" + elt2.username[7] 
                    ...
                    if(element.password2.length<8)
                    element.password2=element.password2[0]  + "******" + element.password2[2] 
else
 ...
 */
                    ...
                    element.username2=elt2.username
                     ...
                     element.password2=element.password2
                  }
      ...
      this.dataSource= new MatTableDataSource<maitres>(this.parents);
