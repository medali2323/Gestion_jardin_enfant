...
@Component({
  selector: 'app-printabsclasse',
  templateUrl: './printabsclasse.component.html',
  styleUrls: ['./printabsclasse.component.css']
})
export class PrintabsclasseComponent implements OnInit {
  enfs:any=[]
  absenfs:any=[]
  timer:any
